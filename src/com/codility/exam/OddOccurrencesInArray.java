...
/*
 * 100% based on codility
 * 
 */
public class OddOccurrencesInArray {

	public static void main(String[] args) {
		System.out.println(new OddOccurrencesInArray().solution(new int[] { 1,1, 2, 4, 4, 3, 2, 1, 1 }));
	}
 ...
 * A[4] = 9 A[5] = 7 A[6] = 9 the function should return 7, as explained in the
 * example above.
 * 
 * Assume that:
 * 
